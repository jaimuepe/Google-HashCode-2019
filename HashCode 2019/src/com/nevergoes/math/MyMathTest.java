...
public class MyMathTest {
	...
	public static void main(String[] args) {
		...
		MyAsserts.isTrue(MyMath.manhattanDistance(new Point(1, 1), new Point(3, 4)) == 5, "Manhattan distance test failed!");
		...
		MyAsserts.isTrue(MyMath.manhattanDistance(new Point(0, 4), new Point(4, 0)) == 8, "Manhattan distance test failed!");
